      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <Alert className="border-info/20 bg-info/5">
          ...
          <AlertDescription className="text-foreground">
            Configure how our AI system forecasts ingredient demand and
            generates automatic replenishment requests. These settings apply to
            all ingredients.
          </AlertDescription>
        </Alert>
        ...
        <Card className="p-6 bg-white border-0 shadow-sm space-y-6">
          <div>
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    The number of days ahead to forecast demand. Longer horizons
                    provide better planning but may be less accurate.
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
            ...
            <p className="text-sm text-muted-foreground">
              {t("currentSelection")}: {forecastHorizon} {t("days")}
            </p>
          </div>
        </Card>
        ...
        <Card className="p-6 bg-white border-0 shadow-sm space-y-4">
          <div className="flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  Minimum confidence level (%) for the AI to automatically
                  generate replenishment requests. Higher values = more
          ...
          <div>
            ...
            <div className="flex justify-between text-xs text-muted-foreground mt-2">
              <span>50% ({t("aggressive")})</span>
              <span>75% ({t("balanced")})</span>
              <span>100% ({t("conservative")})</span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6 bg-white border-0 shadow-sm space-y-4">
          <div className="flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  Extra percentage of forecasted demand to keep as safety stock.
                  Protects against unexpected demand spikes or supply delays.
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
          ...
          <p className="text-xs text-muted-foreground bg-secondary/30 p-3 rounded">
            Example: If forecasted demand is 100 units with 20% buffer, we'll
            recommend ordering 120 units.
          </p>
        </Card>
        ...
        <Card className="p-6 bg-white border-0 shadow-sm space-y-4">
          <div className="flex items-center gap-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="max-w-xs">
                  Average number of days for supplier to deliver. Used to
                  trigger replenishment orders before shortage occurs.
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Input
              ...
              onChange={(e) =>
                setSupplierLeadTime(parseInt(e.target.value) || 0)
              }
              min={0}
              max={14}
              className="max-w-32"
            />
            <span className="font-medium text-foreground">{t("days")}</span>
          </div>

          <p className="text-xs text-muted-foreground bg-secondary/30 p-3 rounded">
            If shortage predicted in 5 days and lead time is 2 days, order will
            be triggered in 3 days to ensure on-time delivery.
          </p>
        </Card>
        ...
        <Card className="p-6 bg-white border-0 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-foreground text-lg">
                Auto-Generate Replenishment Requests
              </h3>
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
          ...
          >
            {autoGenerateRequests ? t("automaticMode") : t("manualMode")}
          </div>
        </Card>
