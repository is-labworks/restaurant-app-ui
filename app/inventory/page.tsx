      ...
      <div className="px-8 py-6 space-y-8">
        ...
        <Card className="p-6 bg-white border-0 shadow-sm">
          <h2 className="font-bold text-foreground mb-4">
            Forecasted Demand vs Current Stock (7-14 Days)
          </h2>
            ...
            <RechartsAreaChart data={forecastData}>
              <defs>
                ...
                <linearGradient id="colorCurrent" x1="0" y1="0" x2="0" y2="1">
                  <stop
                    offset="5%"
                    stopColor="hsl(var(--color-warning))"
                    stopOpacity={0.3}
                  />
                  <stop
                    offset="95%"
        ...
        <Card className="p-6 bg-white border-0 shadow-sm">
          ...
          <Alert className="mb-6 border-warning/20 bg-warning/5">
            ...
            <AlertDescription className="text-warning">
              2 items have critical shortage predictions. Review and confirm
              requests below.
            </AlertDescription>
          </Alert>
                ...
                {replenishmentRequests.map((request) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-foreground">
                      {request.predictedShortage} units
                    </td>
                    <td className="py-3 px-4 text-foreground">
                      ~{request.predictedDay} days
                    </td>
                    <td
                      className={`py-3 px-4 ${priorityColor[request.priority]}`}
                    >
                      {request.priority}
                    </td>
